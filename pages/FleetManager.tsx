...
const FleetManager: React.FC = () => {
  ...
  const handleDeleteVehicle = (id: string, plate: string) => {
    if (window.confirm(`Tem certeza que deseja remover o veículo ${plate}? Esta ação não pode ser desfeita.`)) {
      deleteVehicle(id);
    ...
    <div className="space-y-8 pb-20">
      ...
      {resolvingMaintenance && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white w-full max-md rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in duration-300">
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button 
                      ...
                      className="w-8 h-8 rounded-lg bg-red-50 text-red-300 hover:text-red-500 flex items-center justify-center transition-all"
